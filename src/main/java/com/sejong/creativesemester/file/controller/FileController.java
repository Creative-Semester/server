...
public class FileController {
    ...
    @PostMapping("")
    public SuccessResponse<List<imageInfo>> uploadImage(@Parameter(name = "파일", required = true,
    ...
    @DeleteMapping("")
    public SuccessResponse deleteImage(@Parameter(name = "올려진 파일의 imageName값(Url아님)", required = true,
